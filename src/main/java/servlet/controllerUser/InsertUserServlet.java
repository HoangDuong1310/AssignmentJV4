...
public class InsertUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/view/user/FormInsertUser.jsp").forward(request, response);
	}
...
//		}
		...
		response.sendRedirect("http://localhost:8080/Assignment/user/list");
	}
