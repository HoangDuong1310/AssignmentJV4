 ...
 */
@WebServlet("/admin/card-detail")
public class ShowDetailAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	GaiAnimeModel g = new GaiAnimeModel();
	public ShowDetailAdminServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/view/admin/CardDetailAdmin.jsp").forward(request, response);
	}
