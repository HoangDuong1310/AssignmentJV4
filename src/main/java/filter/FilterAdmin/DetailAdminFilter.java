...
@WebFilter("/admin/card-detail")
public class DetailAdminFilter implements Filter {
...
if (session.getAttribute("role") == role.ADMIN) {
	...
	res.sendRedirect("http://localhost:8080/Assignment/not-allow");
}
	}
