        ...
        * {
        ...
        .support__item {
            ...
            background: linear-gradient(90deg, rgb(0 0 0/ 97%),
                ...
                url(https://www.animegeek.com/wp-content/uploads/2021/05/Overlord-Season-4-release-date-2022-anime.jpg) no-repeat;
        ...
        #tab1 {
            background: linear-gradient(90deg, rgb(0 0 0/ 97%),
                    rgba(30, 38, 44, 0.8) 0%, rgba(30, 38, 44, 0)),
                url(https://animehunch.com/wp-content/uploads/2022/06/Solo-Leveling.jpg) no-repeat;
            max-height: 520px;
            background-size: cover;
            border-radius: 20px;
            height: 100%;
        ...
        #tab2 {
            background: linear-gradient(90deg, rgb(0 0 0/ 97%),
                    rgba(30, 38, 44, 0.8) 0%, rgba(30, 38, 44, 0)),
                url(https://upload.wikimedia.org/wikipedia/vi/e/eb/Sora_no_Otoshimono_DVD_01_cover.jpg) no-repeat;
            max-height: 520px;
            background-size: cover;
            border-radius: 20px;
            height: 100%;
        ...
        #tab3 {
            background: linear-gradient(90deg, rgb(0 0 0/ 97%),
                    rgba(30, 38, 44, 0.8) 0%, rgba(30, 38, 44, 0)),
                url(https://i0.wp.com/www.monstersandcritics.com/wp-content/uploads/2021/03/The-Devil-is-a-Part-Timer-Season-2-release-date-Hataraku-Maou-sama-Season-2-2021.jpg?resize=780%2C439&ssl=1) no-repeat;
            max-height: 520px;
            background-size: cover;
            border-radius: 20px;
            height: 100%;
        ...
        #tab4 {
            background: linear-gradient(90deg, rgb(0 0 0/ 97%),
                    rgba(30, 38, 44, 0.8) 0%, rgba(30, 38, 44, 0)),
                url(https://gamek.mediacdn.vn/133514250583805952/2022/3/7/sword-art-online-16466411035761615694582.jpg) no-repeat;
            max-height: 520px;
            background-size: cover;
            border-radius: 20px;
            height: 100%;
        ...
        <div class="main__wrapper">
            <div class="nav">
                <ul>
                    ...
                    <li class="item active"><a href="index"> <i class="fa-solid fa-house"></i>
                        </a></li>
                    <li class="item"><a href="gai-alime"> <i class="fa-solid fa-tag"></i>
                        </a></li>
                </ul>
            </div>
            <div class="sidebar">
                ...
                <div class="sidebar__support-wrapper">
                    <div class="support__item">
                        <img class="support__item-img"
                            src="https://cdn.dribbble.com/users/1003944/screenshots/2375167/1-ufo-2x.gif" alt="">
                    </div>
            ...
            <div class="content__wrap">
                <div class="content">
                    ...
                    <div class="banner__wrapper">
                        ...
                        <div class="tab__btn">
                            <a href="javascript:void(0)" onclick="openTab(event,'tab1')" class="tab__item"> <img
                                    src="https://animehunch.com/wp-content/uploads/2022/06/Solo-Leveling.jpg" alt="">
                            </a> <a href="javascript:void(0)" onclick="openTab(event,'tab2')" class="tab__item"> <img
                                    src="https://upload.wikimedia.org/wikipedia/vi/e/eb/Sora_no_Otoshimono_DVD_01_cover.jpg"
                                    alt="">
                            </a> <a href="javascript:void(0)" onclick="openTab(event,'tab3')" class="tab__item"> <img
                                    ...
                                    alt="">
                            </a> <a href="javascript:void(0)" onclick="openTab(event,'tab4')" class="tab__item"> <img
                                    src="https://gamek.mediacdn.vn/133514250583805952/2022/3/7/sword-art-online-16466411035761615694582.jpg"
                                    alt="">
                            </a><a href="javascript:void(0)" onclick="openTab(event,'tab5')" class="tab__item"> <img
                    ...
                    <div class="slider">
                        <div class="card">
                            <a href="card-detail.html">
                                <div class="card__top">
                                    <img src="https://cdn.cloudflare.steamstatic.com/steam/apps/1332010/ss_88e209a90c2039fa76bca6fa08c641365be38d50.1920x1080.jpg?t=1658250387" />
                                </div>
                        ...
                        <div class="card">
                            <a href="card-detail.html">
                                <div class="card__top">
                                    <img
                                        src="https://cdn.cloudflare.steamstatic.com/steam/apps/1332010/ss_88e209a90c2039fa76bca6fa08c641365be38d50.1920x1080.jpg?t=1658250387" />
                                </div>
                                <div class="card__main">
                                    <div class="card__main-title">
                                        ${x.name }
