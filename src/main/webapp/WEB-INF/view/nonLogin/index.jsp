	...
	<div class="main__wrapper">
		<div class="nav">
			<ul>
				...
				<li class="item active"><a href="index"> <i
						class="fa-solid fa-house"></i>
				</a></li>
				<li class="item"><a href="gai-alime"> <i
		...
		<div class="sidebar">
			...
			<div class="sidebar__login">
				<button class="sidebar__login-btn"
					onclick="window.location.href='/Assignment/login'">
					<i class="fa-solid fa-right-to-bracket"></i> <span> ${sessionScope.username} </span>
				</button>
				<button class="sidebar__login-btn"
					onclick="window.location.href='/Assignment/register'">
					<i class="fa-solid fa-user-plus"></i>
				</button>
				<button class="sidebar__login-btn"
					onclick="window.location.href='/Assignment/forgot'">
